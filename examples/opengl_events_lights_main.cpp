...
filename: 	opengl_events_lights_main.cpp
file base:	opengl_events_lights_main
file ext:	cpp
...
int main(int argc, char* argv[])
{
	...
	GLWindow win(1024, 768, "Simplest OpenGL Program with Events, Lights, and Material");
	win.show();
